    ...
    <div class="opt">
        <form action="Product_insert.php" method="POST" >
        	<table>
        		<tr>
        			<td>Product :</td>
        			<td><input type="text" placeholder="Product" name="Prodcut" required></td>
        		</tr>
        		<tr>
        			<td>Price:</td>
        		...
        		<tr>
            	    <td><input type="submit" value="Add" name="Card2" id="lo"></td>
      ...
      <?php 
        if (isset($_GET['error'])) {
          if ($_GET['error'] == "SQL_Error") {
             ...
             echo '<label style="color:red">The Card is already taken!</label>'; 
          }
